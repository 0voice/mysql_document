...
![image-20241114171449505](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241114171449505.png)

docker 启动一个 MySQL 8.0.32 的容器：

![image-20241114171525485](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241114171525485.png)

现在我们来看一下启动日志：

![image-20241114171611633](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241114171611633.png)

这里也表明了 `innodb_log_files_in_group` 和 `innodb_log_file_size` 这两个变量是用来计算 `innodb_redo_log_capacity` ，且已经被废弃。

我们再看下日志文件组的文件数是多少：

![img](https://javaguide.cn/assets/redo-log-B8wAvbOi.png)
...
![image-20241114171656223](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241114171656223.png)
