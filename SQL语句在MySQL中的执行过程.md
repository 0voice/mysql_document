...
### [1.1 MySQL 基本架构概览](#_1-1-mysql-基本架构概览)
...
### [1.2 Server 层基本组件介绍](#_1-2-server-层基本组件介绍)
...
#### [2) 查询缓存(MySQL 8.0 版本后移除)](#_2-查询缓存-mysql-8-0-版本后移除)
...
## [二 语句分析](https://javaguide.cn/database/mysql/how-sql-executed-in-mysql.html#二-语句分析)

### [2.1 查询语句](https://javaguide.cn/database/mysql/how-sql-executed-in-mysql.html#_2-1-查询语句)

说了以上这么多，那么究竟一条 SQL 语句是如何执行的呢？其实我们的 SQL 可以分为两种，一种是查询，一种是更新（增加，修改，删除）。我们先分析下查询语句，语句如下：

![image-20241116193739265](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241116193739265.png)
...
### [2.2 更新语句](https://javaguide.cn/database/mysql/how-sql-executed-in-mysql.html#_2-2-更新语句)

以上就是一条查询 SQL 的执行流程，那么接下来我们看看一条更新语句如何执行的呢？SQL 语句如下：

![image-20241116193811933](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241116193811933.png)
