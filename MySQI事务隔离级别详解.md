...
![image-20241115135046690](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241115135046690.png)

MySQL InnoDB 存储引擎的默认支持的隔离级别是 **REPEATABLE-READ（可重读）**。我们可以通过`SELECT @@tx_isolation;`命令来查看，MySQL 8.0 该命令改为`SELECT @@transaction_isolation;

![image-20241115135115047](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241115135115047.png)
...
![image-20241115135212252](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20241115135212252.png)
...
### [避免脏读(读已提交)](https://javaguide.cn/database/mysql/transaction-isolation-level.html#避免脏读-读已提交)

![img](https://oss.javaguide.cn/github/javaguide/2019-31-2%E8%AF%BB%E5%B7%B2%E6%8F%90%E4%BA%A4%E5%AE%9E%E4%BE%8B.jpg)



### [不可重复读](https://javaguide.cn/database/mysql/transaction-isolation-level.html#不可重复读)
...
### [可重复读](https://javaguide.cn/database/mysql/transaction-isolation-level.html#可重复读)

![img](https://oss.javaguide.cn/github/javaguide/2019-33-2%E5%8F%AF%E9%87%8D%E5%A4%8D%E8%AF%BB.jpg)



### [幻读](https://javaguide.cn/database/mysql/transaction-isolation-level.html#幻读)

#### [演示幻读出现的情况](https://javaguide.cn/database/mysql/transaction-isolation-level.html#演示幻读出现的情况)
...
### [参考](https://javaguide.cn/database/mysql/transaction-isolation-level.html#参考)
